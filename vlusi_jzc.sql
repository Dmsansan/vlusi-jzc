...
-- ----------------------------
-- Records of jzc_aftermarket_attachments
-- ----------------------------
...
CREATE TABLE `jzc_amount_card` (
  ...
  `amount_list` varchar(30) DEFAULT NULL COMMENT '代金卡批次',
  `amount_number` varchar(30) DEFAULT NULL COMMENT '代金卡号',
  `amount_password` varchar(30) DEFAULT NULL COMMENT '代金卡密码',
...
-- ----------------------------
-- Records of jzc_favourable_activity
-- ----------------------------
...
-- ----------------------------
-- Records of jzc_reg_extend_info
-- ----------------------------
...
-- ----------------------------
-- Records of jzc_touch_goods_activity
-- ----------------------------
...
-- ----------------------------
-- Records of jzc_touch_user_info
-- ----------------------------
...
-- ----------------------------
-- Records of jzc_wechat_custom_message
-- ----------------------------
...
-- ----------------------------
-- Records of jzc_wechat_mass_history
-- ----------------------------
...
-- ----------------------------
-- Records of jzc_wechat_rule_keywords
-- ----------------------------
...
-- ----------------------------
-- Records of jzc_wechat_user_group
-- ----------------------------
