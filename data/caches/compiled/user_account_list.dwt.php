...
?>
		<li class="dis-shop-list p-r padding-all m-top1px b-color-f  ">
			<div class="dis-box">
				<div class="box-flex">
					<h5 class="f-05 col-7"><?php echo $this->_var['item']['change_time']; ?></h5>
					<h6 class="f-05 col-7  m-top04"><?php echo $this->_var['item']['short_change_desc']; ?></h6>
				</div>
				<div class="box-flex">
					<p class="f-05 color-red text-right"><?php echo $this->_var['item']['amount']; ?></p>
					<h6 class="f-05 col-3 text-right m-top04"><?php echo $this->_var['item']['type']; ?></h6>
				</div>
			</div>
		</li>
