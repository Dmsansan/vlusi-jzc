...
<div class="flow-set-adr of-hidden padding-all ">
	...
	<div class="fr"><a href="<?php echo $this->_var['flow_consignee']['url']; ?>"><i class="iconfont icon-bianji"></i>编辑</a><a href="<?php echo url('user/del_address_list', array('id'=>$this->_var['flow_consignee']['address_id']));?>"><i class="iconfont icon-xiao10"></i>删除</a></div>
</div>
<div class="flow-have-adr padding-all">
	<p class="f-h-adr-title">
